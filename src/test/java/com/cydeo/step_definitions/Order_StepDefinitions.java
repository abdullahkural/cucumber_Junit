...
public class Order_StepDefinitions {
    ...
    public void user_enters_quantity(Integer quantity) {
        ...
        //imitating pressing backspace from keyboard to delete existing input
        orderPage.inputQuantity.sendKeys(Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE);
        orderPage.inputQuantity.sendKeys(quantity+"");
    ...
    public void user_selects_credit_card_type(String expectedCardType) {
        ...
        /*
        We created a method in BrowserUtils
